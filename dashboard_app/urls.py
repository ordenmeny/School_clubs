...
from .views import index, members, delete_member, add_article, message, delete_content
...
urlpatterns = [
    ...
    path('content/delete/<str:model_name>/<slug:content_slug>/', delete_content, name='delete_content'),
